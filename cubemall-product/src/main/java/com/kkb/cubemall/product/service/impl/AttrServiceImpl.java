...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public void deleteRelation(AttrGroupRelationVo[] vos) {
        ...
        //批量移除属性分组和 属性的关联关系  这里可调用delete() 传递条件wrapper的方式 或者通过 原生Mybatis操作
//        relationEntities.forEach((relationEntitity)-> {
//                    QueryWrapper<AttrAttrgroupRelationEntity> queryWrapper = new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_id", relationEntitity.getAttrId()).eq("attr_group_id", relationEntitity.getAttrGroupId());
...
//                });
    ...
    public PageUtils getNoRelationAttr(Map<String, Object> params, Long attrGroupId) {
        ...
        //从中间表 attr_attrgroup_relation中 获取 groupIds 所对应的属性  这里不能通过id批量查，原因在于 attr_group_id并非主键
