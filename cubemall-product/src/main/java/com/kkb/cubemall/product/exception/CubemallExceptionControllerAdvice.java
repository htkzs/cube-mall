...
public class CubemallExceptionControllerAdvice {
    ...
    public R handleVaildException(RemoteServiceCallException exception){
        ...
        return R.error(CubemallEnum.REMOTE_SERVICE_CALL_EXCEPTION.getCode(), CubemallEnum.REMOTE_SERVICE_CALL_EXCEPTION.getMsg()).put("data", "未知异常");
    }
}
